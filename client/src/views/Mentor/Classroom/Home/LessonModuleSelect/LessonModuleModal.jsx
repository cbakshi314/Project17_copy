...
export default function LessonModuleModal({
  ...
  return (
    <div id='lesson-module-modal'>
      <button id='share-btn'><i className="fa fa-solid fa-share"></i></button>
